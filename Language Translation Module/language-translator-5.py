...
class LanguageTranslatorApp:
    ...
    def create_widgets(self):
        # Entry for manual text input or speech recognition output
        ...
        # Button for recording voice input
        self.record_button = Button(self.root, text="Record Voice", bg="#FF5722", fg="white", font=("Arial", 12), command=self.record_voice)
        self.record_button.place(x=640, y=260, width=140, height=40)

        # Dropdown for selecting voice/accent
        voice_options = [
            "Default", "Male", "Female", "British English", "American English", "Australian English",
            "Indian English", "French", "German", "Italian", "Spanish", "Chinese", "Japanese"
        ]

        self.voice_drp_down = StringVar()
        self.voice_drp_down.set("Select Voice")
        self.voice_list = OptionMenu(self.root, self.voice_drp_down, *voice_options)
        self.voice_list.configure(bg="#607D8B", fg="white", font=("Arial", 12))
        self.voice_list.place(x=640, y=320, width=140, height=40)
    ...
    def record_voice(self):
        ...
        try:
            ...
            self.entry_window.delete(0, tk.END)
            self.entry_window.insert(0, recognized_text)
