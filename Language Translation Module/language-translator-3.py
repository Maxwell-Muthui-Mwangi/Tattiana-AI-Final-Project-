...
class LanguageTranslatorApp:
    ...
    def create_widgets(self):
        ...
        self.upload_button = Button(self.root, text="Upload File", bg="blue", fg="white", font=("Arial", 12), command=self.upload_file)
        ...
        self.list_lang.place(x=20, y=80, width=200, height=40)

        # Button to initiate translation
        self.translate_button = Button(self.root, text="Translate!", bg="green", fg="white", font=("Arial", 20, "bold"), command=self.translate_language)
        self.translate_button.place(x=240, y=80, width=160, height=40)
        ...
        self.translated_text_area.place(x=20, y=140, width=740, height=400)

        # Button to copy translated text to clipboard
        self.copy_button = Button(self.root, text="Copy", bg="blue", fg="white", font=("Arial", 12), command=self.copy_translated_text)
        self.copy_button.place(x=680, y=550, width=80, height=40)

        # Button for text-to-speech
        self.tts_button = Button(self.root, text="Text-to-Speech", bg="green", fg="white", font=("Arial", 12), command=self.text_to_speech)
        self.tts_button.place(x=580, y=550, width=100, height=40)
